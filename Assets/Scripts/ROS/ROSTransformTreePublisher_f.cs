...
//         public List<string> globalFrameIds = new List<string> { };
...
//             TransformMsg tm = transformRoot.Transform.To<FLU>();
//             tm.translation.z = 0;
//             if (globalFrameIds.Count > 0)
//             {
//                 var tfRootToGlobal = new TransformStampedMsg(
//                     new HeaderMsg((uint)Math.Floor(Clock.time), new TimeStamp(Clock.time), globalFrameIds.Last()),
//                     transformRoot.name,
//                     tm
//                 );
...
//                     new HeaderMsg((uint)Math.Floor(Clock.time), new TimeStamp(Clock.time), globalFrameIds[i - 1]),
//                     globalFrameIds[i],
