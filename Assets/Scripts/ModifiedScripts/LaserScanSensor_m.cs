...
public class LaserScanSensor_m : MonoBehaviour
{
    ...
    public float RangeMetersMax = 100;
    ...
    public float ScanOffsetAfterPublish = 0;
    ...
    public void Update()
    {
        ...
        var yawBaseDegrees = laserScan.transform.rotation.eulerAngles.y;
        while (m_NumMeasurementsTaken < measurementsSoFar)
        {
            ...
            var measurementStart = RangeMetersMin * directionVector + laserScan.transform.position;
